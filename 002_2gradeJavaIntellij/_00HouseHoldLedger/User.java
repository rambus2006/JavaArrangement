...
class LoginApplication {
    ...
    private static _00HouseHoldLedgerPJ.Gui.User user[] = new User[10];
    ...
    public static void UserMain() {
        ...
        for (int i=0;i<10;i++) {
            user[i] = new _00HouseHoldLedger.User();
        }
    ...
    private static void AccountTest(){
        ...
        _00HouseHoldLedgerPJ.Gui.Account a1 = new _00HouseHoldLedgerPJ.Gui.Account(number, balance);
